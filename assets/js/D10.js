...
*/
me.skill = ["javascript", "HTML", "CSS"];
console.log(me);
/* ESERCIZIO F
  Crea un pezzo di codice per aggiungere un nuovo elemento all'array "skills" contenuto nell'oggetto "me".
*/
me.skill.push("Photoshop");
console.log(me);
/* ESERCIZIO G
...
console.log(splitMe("ciao sono giacomo"));
/* ESERCIZIO 4
  Crea una funzione chiamata "deleteOne" che riceve una stringa e un booleano come parametri.
  Se il valore booleano è true la funzione deve ritornare la stringa senza il primo carattere, altrimenti la deve ritornare senza l'ultimo.
*/
function deleteOne(str1, remove) {
  if (remove) {
    return str1.slice(1);
  } else {
...
console.log(onlyLetters("ho 4 mele"));
/* ESERCIZIO 6
...
console.log(isThisAnEmail("pippo@pippo.com"));
console.log(isThisAnEmail("pippo-pippo.com"));
/* ESERCIZIO 7
...
function howManyDays(date) {
  ...
  let secondi = today - givenDate;
  let giorni = Math.floor(secondi / (1000 * 60 * 60 * 24));
  return giorni;
}
console.log(howManyDays("2023-11-11"));
/* ESERCIZIO 10
  Scrivi una funzione chiamata "isTodayMyBirthday" che deve ritornare true se oggi è il tuo compleanno, falso negli altri casi.
*/
function isTodayMyBirthday() {
  let today = new Date();
  let myBirthday = { day: 13, month: 1 };
  return (
...
*/
let animali = { razza: "Husky", taglia: 25 };
function deleteProp(ogg, prop) {
  delete ogg[prop];
  return ogg;
}
console.log(deleteProp(animali, "taglia"));
/* ESERCIZIO 12
...
function searchByTitle (keyword) {
  return movies.filter(movie => movie.Title.includes(keyword)).map(movie => movie.Title)
}
...
function removeIndex(index) {
  return movies.filter((e, i) => i !== index);
}
